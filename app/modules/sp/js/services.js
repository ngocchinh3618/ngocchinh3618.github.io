		...
		[
			{
				...
				hinh: 'app/modules/sp/img/CAPHE_Americano.png',
				loai: 'cafe'
			}, 
			{
				id: 2,
				...
				hinh: 'app/modules/sp/img/CAPHE_Cafe den da.png',
				loai: 'cafe'
			}, 
			{
				id: 3,
				...
				hinh: 'app/modules/sp/img/CAPHE_Cafe sua Milk Foam.png',
				loai: 'cafe'
			}, 
			{
				id: 4,
				...
				hinh: 'app/modules/sp/img/CAPHE_Cafe sua da.png',
				loai: 'cafe'
			},
			{
				id: 8,
				...
				hinh:'app/modules/sp/img/LATTEDA_Pandan Macchiato.png',
				loai:'Latte đá'
			},
			{
				id:9,
				...
				hinh:'app/modules/sp/img/LATTEDA_Mocha Macchiato.png',
				loai:'Latte đá'
			},
			{
				id:10,
				...
				hinh:'app/modules/sp/img/LATTEDA_Hong tra latte.png',
				loai:'Latte đá'
			},
			{
				id:11,
				...
				hinh:'app/modules/sp/img/LATTEDA_Matcha Latte.png',
				loai:'Latte đá'
			},
			{
				id:12,
				...
				hinh:'app/modules/sp/img/SINHTO_Caramen Ca phe.png',
				loai:'Đá xay'
			},
			{
				id:13,
				...
				hinh:'app/modules/sp/img/SINHTO_Sinh to Den sua.png',
				loai:'Đá xay'
			},
			{
				id:14,
				...
				hinh:'app/modules/sp/img/SINHTO_Matcha dua.png',
				loai:'Đá xay'
			},
			{
				id:15,
				...
				hinh:'app/modules/sp/img/SINHTO_Vai da xay.png',
				loai:'Đá xay'
			},
			{
				id:16,
				...
				hinh:'app/modules/sp/img/TRA_Tra viet quat boba.png',
				loai:'Trà'
			},
			{
				id:17,
				...
				hinh:'app/modules/sp/img/TRA_Tra vai.png',
				loai:'Trà'
			},
			{
				id:18,
				...
				hinh:'app/modules/sp/img/TRA_Hong Tra Milk Foam.png',
				loai:'Trà'
			},
			{
				id:19,
				...
				hinh:'app/modules/sp/img/TRA_Tra dao.png',
				loai:'Trà'
			},
			{
				id:20,
				...
				hinh:'app/modules/sp/img/TRA_Tra oi hong boba.png',
				loai:'Sữa chua'
			},
			{
				id:21,
				...
				hinh:'app/modules/sp/img/SUACHUA_Sua chua ca phe.png',
				loai:'Sữa chua'
			},
			{
				id:22,
				...
				hinh:'app/modules/sp/img/SUACHUA_Sua chua tran chau.png',
				loai:'Sữa chua'
			},
			{
				id:23,
				...
				hinh:'app/modules/sp/img/SUACHUA_Sua chua uong vai.png',
				loai:'Sữa chua'
			},
			{
				id: 5,
				...
				hinh: 'app/modules/sp/img/MONNONG_Cappuccino.png',
				loai: 'Latte nóng'
			}, 
			{
				id: 6,
				...
				hinh: 'app/modules/sp/img/MONNONG_Cappuccino Matcha.png',
				loai: 'Latte nóng'
			}, 
			{
				id: 7,
				...
				hinh: 'app/modules/sp/img/MONNONG_Cappuccino Hong Ngoc.png',
				loai: 'Latte nóng'
			},
